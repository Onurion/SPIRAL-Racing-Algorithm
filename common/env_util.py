...
from common.vec_env import DummyVecEnv, DummyVecEnv_NoSelfPlay, SubprocVecEnv, VecEnv
...
def make_vec_env(
    ...
    if vec_env_cls is None:
        ...
        if selfplay:
            ...
            vec_env_cls = DummyVecEnv_NoSelfPlay
