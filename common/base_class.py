...
from common.callbacks_updated import BaseCallback, CallbackList, ConvertCallback, ProgressBarCallback
...
class BaseAlgorithm(ABC):
    ...
    def _setup_learn(
        ...
        if reset_num_timesteps or self._last_obs is None:
            ...
            self._last_obs, self._last_opponent_obs = self.env.reset()  # type: ignore[assignment]

            # print ("self._last_obs: ", self._last_obs.shape)
            # print ("self._last_opponent_obs: ", self._last_opponent_obs.shape)
